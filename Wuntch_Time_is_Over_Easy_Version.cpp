...
vl plag_hatane_ki_ninja_technique() {
    vl primes = seive(1000005);
    vl queries(1000005, 0);
...
int main() {
    ...
    vl q = plag_hatane_ki_ninja_technique();
    // cout << q.size() << '\n';
