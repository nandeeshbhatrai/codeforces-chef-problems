...
class Solution {
    public:
        void solve(int t) {
            ...
            //     f0r(j , a[0].size()){
            //         if(a[i][j] == 'X'){
            //             if(j+3 < a[0].size() && a[i][j+1] == 'M' && a[i][j+2] == 'A' && a[i][j+3] == 'S'){
            //                 ++ans;
            //             }
            //             if(i+3 < a.size() && a[i+1][j] == 'M' && a[i+2][j] == 'A' && a[i+3][j] == 'S'){
            //                 ++ans;
            //             }
            //             if(i+3 < a.size() && j+3 < a[0].size() && a[i+1][j+1] == 'M' && a[i+2][j+2] == 'A' && a[i+3][j+3] == 'S'){
            //                 ++ans;
            //             }
            //             if(i-3 >= 0 && j+3 < a[0].size() && a[i-1][j+1] == 'M' && a[i-2][j+2] == 'A' && a[i-3][j+3] == 'S'){
            //                 ++ans;
            //             }
            ...
            //                 ++ans;
            //             }
            //             if(i+3 < a.size() && j-3 >= 0 && a[i+1][j-1] == 'M' && a[i+2][j-2] == 'A' && a[i+3][j-3] == 'S'){
            //                 ++ans;
            //             }
            ...
            f1r(i , 1 , a.size()-1){
                f1r(j , 1 , a[0].size()-1){
                    if(a[i][j] == 'A'){
                        ...
                        pp.insert(a[i-1][j+1]);
                        pp.insert(a[i+1][j-1]);
                        if(tt == set<char>{'M', 'S'} && pp == set<char>{'M', 'S'}){
                            ++ans;
                        }
                    }
                }
