...
class Solution {
    public:
        void solve(int t) {
            ...
            // freopen("dec5_2.txt", "r", stdin);
            // if (!freopen("dec5_2.txt", "r", stdin)){
            //     cerr << "Error opening file dec5_1.txt" << endl;
            //     return;
            // }
            ...
            while(getline(cin , line)){
                ...
                f0r(i , temp.size()){
                    f0r(j , i){
                        if(mp[temp[i]].find(temp[j]) != mp[temp[i]].end()){
                            ok = false;
                        }
                    }
                }
