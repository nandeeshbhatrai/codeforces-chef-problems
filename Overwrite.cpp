...
class Solution {
    public:
        void solve(int t) {
            ...
            // check ki original better hai kya
            bool better = true;
            i = 0;
            f1r(j , n-m, n){
                if(a[j] > lex_small[i]){
                    break;
                }else if(a[j] < lex_small[i]){
                    better = false;
                    break;
                }
                ++i;
